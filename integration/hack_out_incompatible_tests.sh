...
' deps/ecto_sql/integration_test/sql/subquery.exs
...
sed -i '/subqueries with map and select expression/ i @tag :map_boolean_in_subquery' deps/ecto_sql/integration_test/sql/subquery.exs

sed -i '/subqueries with map update and select expression/ i @tag :map_boolean_in_subquery' deps/ecto_sql/integration_test/sql/subquery.exs
